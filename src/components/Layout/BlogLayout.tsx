...
const Layout = ({ isHomePage = false, children }) => {
  ...
  return (
    <div data-is-root-path={isHomePage}>
      ...
      <footer className="footer py-8 bg-dark py-5 pb-5 border-top text-light text-body-secondary xbg-body-tertiary">
...
//                         href="#">Older</a> <a class="btn btn-outline-secondary rounded-pill disabled"
//                         aria-disabled="true">Newer</a> </nav>
//             </div>
//             <div class="col-md-4">
