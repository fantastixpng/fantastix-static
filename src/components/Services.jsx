...
class ServiceSection extends React.Component {
  render() {
    return (
      <section id="services" className="py-10 py-lg-20 text-center">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-md-9 col-lg-7 col-xl-6 col-xxl-5">
              ...
              <p
                className="fs-2 mb-15 aos-init aos-animate"
                data-aos="fade-down"
                data-aos-delay={250}>
                Affordable services for your business needs.
              </p>
            </div>
          </div>
          <div className="row">
            <div
              className="col-lg-6 mb-8 aos-init aos-animate"
              data-aos="fade-down"
              data-aos-delay={0}>
              <svg
                width={60}
            ...
            <div
              className="col-lg-6 mb-8 mt-lg-0 mb-lg-0 aos-init aos-animate"
              data-aos="fade-down"
              data-aos-delay={250}>
              <svg width={61} height={60} viewBox="0 0 61 60" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-action-1 d-block mx-auto"><path fillRule="evenodd" clipRule="evenodd" d="M12.4545 30L1.48945 35.8463C1.18993 36.0063 0.939497 36.2447 0.764886 36.5359C0.590276 36.8272 0.498047 37.1604 0.498047 37.5C0.498047 37.8396 0.590276 38.1728 0.764886 38.4641C0.939497 38.7553 1.18993 38.9937 1.48945 39.1537L29.6145 54.1537C29.8857 54.2982 30.1884 54.3738 30.4957 54.3738C30.803 54.3738 31.1057 54.2982 31.377 54.1537L59.502 39.1537C59.8015 38.9937 60.0519 38.7553 60.2265 38.4641C60.4011 38.1728 60.4934 37.8396 60.4934 37.5C60.4934 37.1604 60.4011 36.8272 60.2265 36.5359C60.0519 36.2447 59.8015 36.0063 59.502 35.8463L48.5482 30L44.562 32.1263L54.642 37.5L30.4995 50.3737L6.35695 37.5L16.437 32.1263L12.4507 30H12.4545Z"/><path fillRule="evenodd" clipRule="evenodd" d="M29.6184 5.84695C29.8896 5.7025 30.1923 5.62695 30.4996 5.62695C30.807 5.62695 31.1096 5.7025 31.3809 5.84695L59.5059 20.847C59.8054 21.007 60.0558 21.2454 60.2304 21.5366C60.405 21.8279 60.4973 22.1611 60.4973 22.5007C60.4973 22.8403 60.405 23.1735 60.2304 23.4648C60.0558 23.756 59.8054 23.9944 59.5059 24.1545L31.3809 39.1545C31.1096 39.2989 30.807 39.3745 30.4996 39.3745C30.1923 39.3745 29.8896 39.2989 29.6184 39.1545L1.49336 24.1545C1.19384 23.9944 0.943403 23.756 0.768792 23.4648C0.594182 23.1735 0.501953 22.8403 0.501953 22.5007C0.501953 22.1611 0.594182 21.8279 0.768792 21.5366C0.943403 21.2454 1.19384 21.007 1.49336 20.847L29.6184 5.84695ZM6.36086 22.5007L30.4996 35.3745L54.6421 22.5007L30.4996 9.62695L6.35711 22.5007H6.36086Z"/></svg>
              <h5 className="mb-4 mt-6">Website Development</h5>
              <p className="mb-0">
                Affordable Website Development for
                <br />
                your business needs.
              </p>
            </div>
