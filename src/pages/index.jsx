  ...
  <Layout>
      ...
      <Container>
        <Row className="g-5 justify-content-center mb-16">
          <Col md={9} lg={8} className="text-center">
            ...
            <p className="lead">
            Fantastix is a web design and development startup based in Madang. Fantastix was started with a mission to assist businesses
            whether large or small to have an online presence. At Fantastix we believe in having a beautiful website that not only generates
            revenue but attracts customers which in turns generates revenue. That is why at Fantastix we strive to build websites that use
            new modern web technologies to achieve the best possible websites for our clients.
            </p>
          </Col>
        </Row>
        <Row>
    ...
    {/*<section id="process" className="">
      <Container>
        <Row className="justify-content-center">
          <Col md={9} lg={7} xl={6} xxl={5}>
            <h5 className="display-5 mb-10 aos-init aos-animate" data-aos="fade-down" data-aos-delay="0">How We Get Started</h5>
          </Col>
        </Row>
        <Row>
          ...
          <Col sm={12} md={6} lg={6} className="mt-10">
            <div className="">
              <ul className="big-bullet-points-list">
                <li className="bullet-points">We schedule a meeting with you to discover your project</li>
                <li className="bullet-points">Then we break down your project into iterations to estimate them with our developers</li>
                <li className="bullet-points">We create a proposal and explain all details related to the working process</li>
                <li className="bullet-points">Once we get a go-ahead, our project manager kicks off internal meeting to get started</li>
              </ul>
            </div>
          </Col>
        </Row>
      ...
      <Container>
        ...
        <Row className="g-2 justify-content-center text-dark">
          <Col sm={10} md={3} lg={3} className="mb-8 mb-lg-0 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
            <div className="d-flex flex-column justify-content-between h-100 p-6 xborder rounded-2 border-dark-3 bg-bg-3">
              ...
              <Button href="#contact" className="btn-bg-1 mt-6 w-100">Enquire</Button>
            </div>
          </Col>
          <Col sm={10} md={3} lg={3} className="mb-8 mb-lg-0 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
            <div className="d-flex flex-column justify-content-between h-100 p-6 xborder rounded-2 border-dark-3 bg-bg-3">
              ...
              <Button href="#contact" className="btn-bg-1 btn-action-1 mt-6 w-100">Enquire</Button>
            </div>
          </Col>
          <Col sm={10} md={3} lg={3} className="mb-8 mb-lg-0 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
            <div className="d-flex flex-column justify-content-between h-100 p-6 xborder rounded-2 border-dark-3 bg-bg-3">
              ...
              <Button href="#contact" className="btn-bg-1 btn-action-3 mt-6 w-100">Enquire</Button>
            </div>
          </Col>
        ...
        <Row className="g-5 text-light">
          <Col className="d-grid justify-content-center">
            <span className="text-small">(Additional pages costs K300 per page)</span>
            <span className="text-small">*price excludes VAT, if applicable</span>
          </Col>
        </Row>
      </Container>
    </section>
      ...
      <Container>
        <Row className="mb-4 mb-lg-5">
          <div className="col-12 col-sm-12 col-md-10 col-lg-8 col-xl-8 mx-auto">
            ...
            <p>
              We love hearing from our clients. Whether its feedback, queries or even criticism, we are all ears.<br/>
              Contact us now to discuss how we can scale your project to the next level and we will get in touch
              with you as soon as possible, we promise🤝.
            </p>
          </div>
        </Row>
