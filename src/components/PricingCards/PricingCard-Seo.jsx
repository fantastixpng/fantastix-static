...
const PricingCardSeo = () => (
  <Row className="g-2 justify-content-center">
    <Col sm={10} md={4} lg={4} className="mb-8 mb-lg-0 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
      <div className="d-flex flex-column justify-content-between h-100 p-6 xborder rounded-2 border-dark-3 bg-bg-3">
        <div>
          <h2 className="fs-2 mb-4 text-dark-2">SEO Package</h2>
          <h2 className="display-6 mb-6">K1,000</h2>
