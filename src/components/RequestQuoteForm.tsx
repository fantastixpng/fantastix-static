  ...
  if (state.succeeded) {
    return (
      <p className="container">
        Thank you for your request. We will review the details and provide you with a quotation shortly.
      </p>
    );
  }
  ...
  return (
    <form
      ...
      <div className="row g-3">
        ...
        <div className="col-12 col-lg-4">
          <div className="form-floating mb-3">
            <input name="phone" type="tel" className="form-control" id="phone" placeholder="phone number" />
        ...
        <div className="col-12 col-lg-4">
          <div className="form-floating mb-3">
            <select name="industry" id="industry" className="form-select" aria-label="Select your industry">
...
<label htmlFor="categoty">Type of app</label>
        ...
        <div className="col-12 col-lg-6">
          <div className="form-floating mb-3">
            <select name="start-time" id="start" className="form-select" aria-label="Floating label select example">
...
<label className="form-check-label" htmlFor="project_needs_2">E-Commerce</label>
        ...
        {/* <div hidden className="row g-2">
          <div className="col">
            <div className="form-check">
              <input className="form-check-input" type="checkbox" value="" id="NDA" />
        ...
        <div className="text-center mt-10">
          <button className="btn btn-lg bg-dark text-light w-100 w-md-auto" type="submit" disabled={state.submitting}>Get a quote</button>
        </div>
